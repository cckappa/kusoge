...
signal enemy_button_pressed(enemy: Character, control: Control, enemy_container: EnemyBattleClass)
...
signal menu_party_switch_button_pressed(character: Character, container: MarginContainer)
